...
public interface IDatameerWatchDog {
	...
	public String deleteImportJob(String username,String password,String datameerServerIP,String portNumber,String jobConfigurationId);
	...
	//curl -u <username>:<password> -X DELETE http://<Datameer-serverIP>:<port-number>/rest/workbook/<job-configuration-id>
	public String deleteWorkBookJob(String username,String password,String datameerServerIP,String portNumber,String jobConfigurationId);
	...
	//curl -u <username>:<password> -X DELETE http://<Datameer-serverIP>:<port-number>/rest/export-job/<job-configuration-id>
	public String deleteExportJob(String username,String password,String datameerServerIP,String portNumber,String jobConfigurationId);
